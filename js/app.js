...
Game.prototype.getRandCell = function() {
  var randomRowIndex = Math.floor( Math.random() * this.board.length );
  var randomCellIndex = Math.floor( Math.random() * this.board[ 0 ].length );
...
Game.prototype.getNewNum = function() {
  var possibilities = [ 2,2,2,2,2,2,2,4,4,4,4 ];
...
Game.prototype.transpose = function( arr ) {
  // Took this transpose method from a Stack Overflow post
